...
<div>
  ...
  <div class="px-4 lg:px-6 lg:px-8 ">
    <div data-hs-carousel='{
      ...
      <div class="hs-carousel relative overflow-hidden w-full h-[30rem] md:h-[calc(100vh-106px)] md:h-[calc(100vh-106px)] bg-gray-100 rounded-2xl dark:bg-neutral-800">
        <div class="absolute top-0 bottom-0 flex transition-transform duration-700 opacity-0 hs-carousel-body start-0 flex-nowrap">
          ...
          <div class="hs-carousel-slide">
            <div
              class="h-[30rem] md:h-[calc(100vh-106px)] md:h-[calc(100vh-106px)] flex flex-col bg-cover bg-center bg-no-repeat bg-[url('https://images.unsplash.com/photo-1615615228002-890bb61cac6e?q=80&w=3540&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')]">
              <div class="w-2/3 pb-5 mt-auto md:max-w-lg ps-5 md:ps-10 md:pb-10">
                ...
                <div class="mt-5">
                  <a class="inline-flex items-center px-3 py-2 text-sm font-medium text-black bg-white border border-transparent gap-x-2 rounded-xl hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none"
                    href="#">
                    Read Case Studies
                  </a>
                </div>
          ...
          <div class="hs-carousel-slide">
            <div
              class="h-[30rem] md:h-[calc(100vh-106px)] md:h-[calc(100vh-106px)] flex flex-col bg-cover bg-center bg-no-repeat bg-[url('https://images.unsplash.com/photo-1612287230202-1ff1d85d1bdf?q=80&w=3542&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')]">
              <div class="w-2/3 pb-5 mt-auto md:max-w-lg ps-5 md:ps-10 md:pb-10">
          ...
          <div class="hs-carousel-slide">
            <div
              class="h-[30rem] md:h-[calc(100vh-106px)] md:h-[calc(100vh-106px)] flex flex-col bg-cover bg-center bg-no-repeat bg-[url('https://images.unsplash.com/photo-1629666451094-8908989cae90?q=80&w=3464&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')]">
              <div class="w-2/3 pb-5 mt-auto md:max-w-lg ps-5 md:ps-10 md:pb-10">
      ...
      <button type="button"
        ...
        <span class="text-2xl"
          aria-hidden="true">
          <svg class="flex-shrink-0 size-3.5 md:size-4"
  ...
  <div class="px-4 lg:px-6 lg:px-8">
    <div
      ...
      <div class="flex items-center justify-between gap-x-4">
        <svg class="h-auto mx-auto text-black w-14 md:w-20 dark:text-white"
        ...
        <svg class="hidden h-auto mx-auto text-black sm:block w-14 md:w-20 dark:text-white"
          xmlns="http://www.w3.org/2000/svg"
          x="0"
          y="0"
          viewBox="0 0 88 22"
          ...
          <path
            ...
            fill="currentColor" />
          <path d="M37.7 0H40.8V17.1H37.7z"
            fill="currentColor" />
          <path
            ...
            fill="currentColor" />
          <path d="M55.3 5.1 59 5.1 62 11.5 65.2 5.1 68.6 5.1 62 17.8z"
            fill="currentColor" />
          <path
        ...
        <svg class="hidden h-auto mx-auto text-black md:block w-14 md:w-20 dark:text-white"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 107 32">
          <g clip-path="url(#a)"
  ...
  <div class="px-4 py-12 mx-auto max-w-7xl lg:px-6 lg:px-8 lg:py-24">
    ...
    <div class="mt-10 text-center lg:mt-20">
      <a class="relative inline-block font-medium md:text-lg text-black before:absolute before:bottom-0.5 before:start-0 before:-z-[1] before:w-full before:h-1 before:bg-lime-400 hover:before:bg-black focus:outline-none focus:before:bg-black dark:text-white dark:hover:before:bg-white dark:focus:before:bg-white"
        href="#">
        View all Work
      </a>
    </div>
      ...
      <blockquote class="max-w-4xl mx-auto">
        ...
        <footer class="mt-6 md:mt-10">
          <div class="border-neutral-700">
            <button type="button"
              class="inline-flex items-center text-sm group gap-x-3 text-neutral-400 focus:outline-none disabled:opacity-50 disabled:pointer-events-none">
