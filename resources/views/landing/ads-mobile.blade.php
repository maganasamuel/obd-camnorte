<div class="px-4 lg:hidden">
  <div
    ...
    <div x-data="{ logosWidth: 0, logosWrapperWidth: 0 }"
      ...
      x-ref="logosWrapper"
      x-bind:class="{
          'w-full inline-flex flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_160px,_black_calc(100%-160px),transparent_100%)]': true,
